...
<head>
    <meta charset="utf-8">
    <title>Laporan Stok Bapok</title>
    <style>
...
<body>
    ...
    <h2 style="text-align:center; margin-bottom:8px;">Laporan Stok Bapok Mingguan</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:120px; background-color:#059669; color:#ffffff;">Stok</th>
